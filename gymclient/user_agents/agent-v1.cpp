...
namespace UserAgents {
    MMAI::Schema::Action AgentV1::getAction(const MMAI::Schema::IState * s) {
    ...
    MMAI::Schema::Action AgentV1::promptAction(const MMAI::Schema::ActionMask &mask) {
        int num;
    ...
    MMAI::Schema::Action AgentV1::recordedAction() {
    ...
    MMAI::Schema::Action AgentV1::randomValidAction(const MMAI::Schema::ActionMask &mask) {
    ...
    MMAI::Schema::Action AgentV1::firstValidAction(const MMAI::Schema::ActionMask &mask) {
        for (int j = 1; j < mask.size(); j++)
            if (mask[j]) return j;
