...
GlobalStats::GlobalStats(BattleSide side, int battleRound, int value, int hp)
{
	...
	static_assert(EI(GA::_count) == 11, "whistleblower in case attributes change");
	...
	setattr(GA::BATTLE_ROUND, battleRound);
