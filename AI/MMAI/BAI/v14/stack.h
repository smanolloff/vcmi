...
using StackAttribute = Schema::V14::StackAttribute;
using StackAttrs = Schema::V14::StackAttrs;
using StackFlag1 = Schema::V14::StackFlag1;
using StackFlag2 = Schema::V14::StackFlag2;
using StackFlags1 = Schema::V14::StackFlags1;
using StackFlags2 = Schema::V14::StackFlags2;

using Queue = std::vector<uint32_t>; // item=unit id
using BitQueue = std::bitset<S14::STACK_QUEUE_SIZE>;

static_assert(1 << S14::STACK_QUEUE_SIZE < std::numeric_limits<int>::max(), "BitQueue must be convertible to int");

/*
 * A wrapper around CStack
 */
class Stack : public Schema::V14::IStack
{
public:
