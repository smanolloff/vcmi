...
Schema::V14::AttackLogs SupplementaryData::getAttackLogs() const
{
	auto res = Schema::V14::AttackLogs{};
...
Schema::V14::StateTransitions SupplementaryData::getStateTransitions() const
{
	auto res = Schema::V14::StateTransitions{};
