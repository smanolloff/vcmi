...
{
using HexAction = Schema::V14::HexAction;
using HexAttribute = Schema::V14::HexAttribute;
using HexAttrs = Schema::V14::HexAttrs;
using HexState = Schema::V14::HexState;
 ...
 */
class Hex : public Schema::V14::IHex
{
public:
