...
std::vector<const char *> NNModel::readInputNames()
{
	 ...
	 *   [0] battlefield state
	 *        dtype=float
	 *        shape=[S] where S=Schema::V14::BATTLEFIELD_STATE_SIZE
	 *   [1] edge index
	 *        dtype=int32
...
int NNModel::getAction(const MMAI::Schema::IState * s)
{
	...
	const auto * sup = std::any_cast<const MMAI::Schema::V14::ISupplementaryData *>(any);
...
std::vector<Ort::Value> NNModel::prepareInputsV13(const MMAI::Schema::IState * s, const MMAI::Schema::V14::ISupplementaryData * sup)
{
