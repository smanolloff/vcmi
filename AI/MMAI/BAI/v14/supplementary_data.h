...
class SupplementaryData : public Schema::V14::ISupplementaryData
{
public:
	...
	Schema::V14::Stacks getStacks() const override;
	Schema::V14::Hexes getHexes() const override;
	Schema::V14::AllLinks getAllLinks() const override;
	Schema::V14::AttackLogs getAttackLogs() const override;
	Schema::V14::StateTransitions getStateTransitions() const override;
	const Schema::V14::IGlobalStats * getGlobalStats() const override
	{
		return gstats;
	}
	const Schema::V14::IPlayerStats * getLeftPlayerStats() const override
	{
		return lpstats;
	}
	const Schema::V14::IPlayerStats * getRightPlayerStats() const override
	{
		return rpstats;
	}
