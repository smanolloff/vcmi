...
namespace
{
	constexpr int LT_COUNT = EI(MMAI::Schema::V15::LinkType::_count);
...
std::vector<const char *> NNModel::readInputNames()
{
	 ...
	 *   [0] battlefield state
	 *        dtype=float
	 *        shape=[S] where S=Schema::V15::BATTLEFIELD_STATE_SIZE
	 *   [1] edge index
	 *        dtype=int32
...
std::vector<Ort::Value> NNModel::prepareInputsV13(const MMAI::Schema::IState * s, const MMAI::Schema::V15::ISupplementaryData * sup)
{
