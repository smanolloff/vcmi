...
) : side(side)
{
    ...
    setattr(A::VALUE_KILLED_ACC_ABS, valueKilled);
    ...
    setattr(A::VALUE_LOST_ACC_ABS, valueLost);
    ...
    setattr(A::DMG_DEALT_ACC_ABS, dmgDealt);
    ...
    setattr(A::DMG_RECEIVED_ACC_ABS, dmgReceived);
