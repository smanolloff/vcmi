...
namespace detail
{
    using Action_Shoots_Unit_Traits = S15::EncodingTraits<S15::Graph::EdgeAttributes::Action_Shoots_Unit>;
    using Action_Shoots_Unit_Base = Base<Nodes::Action, Nodes::Unit, Action_Shoots_Unit_Traits>;
}
