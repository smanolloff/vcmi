...
static constexpr int BF_XMAX = 15; // GameConstants::BFIELD_WIDTH - 2 (ignore "side" cols)
static constexpr int BF_YMAX = 11; // GameConstants::BFIELD_HEIGHT
static constexpr int BF_SIZE = 165; // BF_XMAX * BF_YMAX
}
