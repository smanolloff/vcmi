...
namespace MMAI {
  ...
  class BAI : public CBattleGameInterface
  {
    ...
    std::unique_ptr<MMAIExport::Result> result;
    MMAIExport::F_GetAction getAction;

    BuildActionResult buildAction(Battlefield &bf, Action &action);
    MMAIExport::Result buildResult(Battlefield &bf);
  ...
  public:
    ...
    void myInitBattleInterface(std::shared_ptr<Environment> ENV, std::shared_ptr<CBattleCallback> CB, MMAIExport::F_GetAction f_getAction);
