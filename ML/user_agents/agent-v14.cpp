...
#include "AI/MMAI/schema/v14/types.h"

namespace ML {
    namespace UserAgents {
        std::string AgentV14::getName() { return "UserAgent (v14)"; };
        int AgentV14::getVersion() { return 14; };
        double AgentV14::getValue(const MMAI::Schema::IState * s) { return -666; };

        MMAI::Schema::Action AgentV14::getAction(const MMAI::Schema::IState * s) {
            MMAI::Schema::Action act;

            if (s->version() != 14)
                throw std::runtime_error("Expected version 14, got: " + std::to_string(s->version()));
            ...
            auto sup = std::any_cast<const MMAI::Schema::V14::ISupplementaryData*>(any);
            ...
            if (sup->getType() == MMAI::Schema::V14::ISupplementaryData::Type::ANSI_RENDER) {
        ...
        MMAI::Schema::Action AgentV14::promptAction(const MMAI::Schema::ActionMask* mask) {
            int num;
        ...
        MMAI::Schema::Action AgentV14::recordedAction() {
        ...
        MMAI::Schema::Action AgentV14::randomValidAction(const MMAI::Schema::ActionMask* mask) {
        ...
        MMAI::Schema::Action AgentV14::firstValidAction(const MMAI::Schema::ActionMask* mask) {
            for (int j = 1; j < mask->size(); j++)
                if ((*mask)[j]) return j;
