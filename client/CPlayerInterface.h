...
public: // TODO: make private
	...
	std::any aiBaggage;
	void prepareAutoFightingAI(const CCreatureSet *army1, const CCreatureSet *army2, int3 tile, const CGHeroInstance *hero1, const CGHeroInstance *hero2, bool side);
